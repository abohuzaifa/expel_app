...
Route::match(['get', 'post'], '/success/{id}/{offer_id}', [SuccessController::class, 'index'])->name('success');
...
Route::match(['get', 'post'], '/charge_in/{id}', [SuccessController::class, 'charge_in'])->name('charge_in');
